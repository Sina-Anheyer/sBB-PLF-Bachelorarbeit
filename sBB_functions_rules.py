...
def branch_and_bound(m,n,plf_values,env_breakpoints_x,env_breakpoints_y,
                     PLFs_breakpoints_x,PLFs_breakpoints_y, problem, rule):
    '''
    ...
    problem : string
        Test problem to be solved.
    rule : string
        either "largest error","longest edge" or "breakpoint"
...
#----------------------------------------------------------------------------------------------------
# Subfunction of branch-and-bound function to solve a child node by using warm start from parent node
#---------------------------------------------------------------------------------------------------
